...
export const AdminHamburgerDrawer: React.FC<AdminHamburgerDrawerProps> = ({ isOpen, onClose }) => {
  const { 
    currentPath, 
    navigate, 
    categories, 
  ...
  // Helper for category navigation from admin side
        ...
        <div className="w-screen max-w-md bg-[#08090D] border-r border-amber-500/20 shadow-2xl shadow-black flex flex-col justify-between transform transition-transform duration-300 ease-in-out animate-slideInLeft text-zinc-100 overflow-hidden">
          ...
          <div className="px-6 py-5 border-b border-zinc-800/80 flex items-center justify-between bg-zinc-950/80 backdrop-blur-xl">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-zinc-950 font-black text-xs shadow-md shadow-amber-500/30">
                LV
              </div>
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6 scrollbar-thin scrollbar-thumb-amber-500/20">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 gap-2">
                ...
                <button
                  ...
                  className={`w-full p-3.5 rounded-xl border text-left flex items-center justify-between transition-all duration-200 group cursor-pointer ${
                    currentPath === '/admin/dashboard'
                      ? 'bg-amber-500/20 border-amber-400/50 text-amber-300 font-bold shadow-md shadow-amber-500/10'
                      : 'bg-zinc-900/60 hover:bg-zinc-900 border-zinc-800/80 hover:border-zinc-700 text-zinc-200 hover:text-white'
                  }`}
                >
                  <div className="flex items-center space-x-3">
                    <div className="p-2 rounded-lg bg-amber-400/15 text-amber-400 border border-amber-500/20">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-sans text-zinc-400">
                        Live analytics, orders, & store overview
                      </p>
                    </div>
                  </div>
                  <ArrowRight className="w-4 h-4 text-zinc-400 group-hover:translate-x-1 transition-transform group-hover:text-amber-300" />
                </button>
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-sans text-zinc-400">
                        View live luxury storefront experience
                      </p>
                    </div>
                  </div>
            ...
            {/* =========================================================================
                OPTION 2: SHOP (Categories & Catalog)
            ========================================================================= */}
            <div className="space-y-2">
              ...
              <div className="bg-zinc-900/70 border border-zinc-800/80 rounded-2xl overflow-hidden transition-all">
                  ...
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] font-sans text-zinc-400 mt-0.5">
                        Manage products & filter by category
                      </p>
                    </div>
                  </div>
                ...
                {/* Submenu: ALL Dynamic Categories */}
                {shopExpanded && (
                  <div className="border-t border-zinc-800/80 bg-zinc-950/60 p-3 space-y-2 animate-fadeIn">
                    ...
                    <button
                      ...
                      className="w-full p-2.5 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 text-amber-300 font-mono text-xs font-bold uppercase flex items-center justify-between transition-all cursor-pointer"
                    >
                      <div className="flex items-center space-x-2">
                    ...
                    {categories.map((cat) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full p-3 rounded-xl border border-zinc-800/60 bg-zinc-900/40 hover:bg-zinc-900 hover:border-amber-400/40 text-left transition-all flex items-center justify-between text-zinc-300 hover:text-white group cursor-pointer"
                        >
            ...
            {/* =========================================================================
                OPTION 3: CONTACT ADMIN & SUPPORT DETAILS
            ========================================================================= */}
            <div className="space-y-2">
              <div className="flex items-center justify-between px-1">
                <span className="text-[10px] font-mono uppercase tracking-[0.25em] text-zinc-400 font-bold">
                  03. CONTACT ADMIN & SUPPORT
                </span>
                <button
                  onClick={() => {
                  ...
                  className="text-[10px] font-mono text-amber-400 hover:text-amber-300 bg-amber-500/10 hover:bg-amber-500/20 border border-amber-500/30 px-2 py-0.5 rounded-full font-bold flex items-center space-x-1 transition-all cursor-pointer"
                  title="Edit contact info in settings"
                >
                ...
                >
                  <div className="flex items-center space-x-3.5">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] font-sans text-zinc-400 mt-0.5">
                        Live channels configured for clients
                      </p>
                    </div>
                  </div>
                  <button className="p-1 text-zinc-400 hover:text-amber-300 transition-colors">
                      ...
                      <div className="flex items-center space-x-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-emerald-400/80 font-sans mt-0.5">
                            Click to test launch WhatsApp chat
                          </p>
                        </div>
                      </div>
          ...
          <div className="p-6 border-t border-zinc-800/80 bg-zinc-950/90 text-center space-y-2">
            <div className="flex items-center justify-center space-x-2 text-[10px] font-mono text-zinc-400 uppercase tracking-widest">
              ...
              <span>ADMIN ATELIER CONSOLE • LIVE DATA SYNC</span>
            </div>
          </div>
