...
export const CheckoutModal: React.FC<CheckoutModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleCopyEasypaisaNumber = () => {
    const numberToCopy = paymentSettings?.easypaisaNumber || '0345-8899123';
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-1 border-t border-zinc-900">
                    <div>
                      <div className="text-lg font-mono font-bold text-white tracking-wider">
                        {paymentSettings?.easypaisaNumber || '0345-8899123'}
                      </div>
                      <div className="text-[11px] text-zinc-400 font-medium">
                        Title: <strong className="text-emerald-300">{paymentSettings?.easypaisaAccountTitle || 'LUNOVA Luxury Lighting Ltd'}</strong>
                      </div>
                    </div>
